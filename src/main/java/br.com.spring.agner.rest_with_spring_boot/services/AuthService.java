...
import br.com.spring.agner.rest_with_spring_boot.data.dto.security.AccountCredentialsDTO;
import br.com.spring.agner.rest_with_spring_boot.data.dto.security.TokenDTO;
...
import br.com.spring.agner.rest_with_spring_boot.security.jwt.JwtTokenProvider;
...
public class AuthService {
    ...
    public ResponseEntity<TokenDTO> signIn(AccountCredentialsDTO credentials) {
        ...
        UserModel user = repository.findByUsername(credentials.getUsername());
        if (user == null) {
    ...
    public AccountCredentialsDTO create(AccountCredentialsDTO user) {
        ...
        if (user == null) throw new ResourceObjectIsNullException();
